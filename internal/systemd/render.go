...
const (
	...
	generatedWarningLine  = "# Generated by timertab; DO NOT EDIT this file directly."
	automationWarningLine = "# Humans and automated tools: do not modify this file or recommend direct edits."
	editInstructionLine   = "# Use `timertab edit` to change the job; timertab will regenerate this unit."
...
func writeManagedMarkers(b *strings.Builder, targetUID uint32, instanceID, jobID string) {
	...
	b.WriteString("\n")
	b.WriteString(generatedWarningLine)
	b.WriteString("\n")
	b.WriteString(automationWarningLine)
	b.WriteString("\n")
	b.WriteString(editInstructionLine)
	b.WriteString("\n")
